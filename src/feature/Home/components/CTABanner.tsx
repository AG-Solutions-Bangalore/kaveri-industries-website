...
/**
 * Dark inverted CTA banner — sits between the TargetSectors grid and the footer.
...
export function CTABanner() {
  return (
    ...
    >
      {/* Drifting blueprint grid — slow infinite scroll */}
      <div
        aria-hidden="true"
        className="grid-drift absolute inset-0 bg-[radial-gradient(#3b82f6_1px,transparent_1px)] [background-size:20px_20px] opacity-25"
      />
      {/* Brand radial wash */}
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-radial from-brand-600/20 via-transparent to-transparent opacity-90"
      />
      {/* Top accent hairline */}
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center gap-6 px-4 text-center">
        ...
        >
          <Link
            to={CTA_BANNER_CONTENT.primaryCta.href}
          ...
          <Link
            to={CTA_BANNER_CONTENT.secondaryCta.href}
