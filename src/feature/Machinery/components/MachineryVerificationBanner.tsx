...
import { MACHINERY_VERIFICATION_DATA } from "../api/machineryConstants";

export function MachineryVerificationBanner() {
  ...
  return (
    <section
      aria-labelledby="machinery-verification-heading"
      className="bg-white py-12 dark:bg-[#050c18]"
    >
          ...
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="shrink-0 lg:self-center">
              ...
              >
                ...
                {MACHINERY_VERIFICATION_DATA.ctaText}
              </button>
            </div>
          </div>
        </div>
